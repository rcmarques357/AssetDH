...
export function Sidebar({ isCollapsed, onToggle, className }: SidebarProps) {
  ...
  const navItems = [
      ...
      subItems: [
        ...
        },
        {
          ...
          subItems: [
            ...
            {
              title: "GIS to SAP Discrepancy",
              href: "/dashboards/asset-data-quality/gis-sap-discrepancy",
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      subItems: [
        {
          title: "Customer Transformer Detection",
          href: "/projects/customer-transformer-detection",
        },
      ],
    },
    {
      ...
      subItems: [
        ...
        { title: "Governance & Standards", href: "/documentation/governance" },
        {
          ...
          href: "/documentation/processes-procedures",
        },
        {
          title: "Training & Tutorials",
          href: "/documentation/training-tutorials",
        },
      ],
    },
    /* {
  ...
  return (
    ...
    >
              ...
              <div key={index}>
                ...
                >
                  <Link
                    ...
                    onClick={(e) =>
                      hasSubItems && !isCollapsed && e.preventDefault()
                    }
                  >
                        ...
                        <div key={subIndex}>
                          ...
                          >
                            <Link
                              ...
                              onClick={(e) =>
                                hasSubSubItems && e.preventDefault()
                              }
                            >
      ...
      <div className="p-4 border-t border-sidebar-border">
        ...
        >
          <p className="font-medium">Asset Data Strategy</p>
