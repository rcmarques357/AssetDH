    ...
    <PageLayout title="Asset Data Process Dashboard">
      {!hasValidUrl ? (
        <Alert className="mb-6">
          ...
          <AlertDescription>
            Dashboard to be added using a Power BI iframe. {/* <code className="bg-muted px-1 py-0.5 rounded">src/pages/AssetDataProcess.tsx</code> with your Power BI embed URL 
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
           Asset data processing metrics and insights
          </CardDescription>
        </CardHeader>
